public class Osoba {
    //Osoba poseduje Ime, Prezime, godinu rodjenja i JMBG. Ime, prezime, godina rodjenja i JMBG se zadaju prilikom kreiranja.
    // Ime i prezime mogu da se dohvate i naknadno postave. Godina rodjenja i JMBG mogu samo da se dohvate. Izvrsiti proveru
...
// [Ime Prezime]{GodinaRodjenja}<JMBG>
    ...
    public String toString() {
        return "[" + ime + " " + prezime + "]{" + godRodj + "}<" + jmbg + ">";
    }
}
